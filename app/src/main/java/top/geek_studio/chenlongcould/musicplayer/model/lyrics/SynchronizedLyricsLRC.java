package top.geek_studio.chenlongcould.musicplayer.model.lyrics;
...
//                    String value = attrMatcher.group(ic_launcher).toLowerCase().trim();
//                    switch (attr) {
//                        case "offset":
...
//                    String text = matcher.group(ic_launcher);
//
...
//                            s = Float.parseFloat(timeMatcher.group(ic_launcher));
