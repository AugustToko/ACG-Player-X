...
public class RetroUtil {
    ...
    public static boolean isTablet() {
        return App.Companion.getInstance().getResources().getConfiguration().smallestScreenWidthDp >= 600;
    }

    public static boolean isLandscape() {
        return App.Companion.getInstance().getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE;
    }
    ...
    public static int getStatusBarHeight() {
        int result = 0;
        int resourceId = App.Companion.getInstance().getResources().getIdentifier("status_bar_height", "dimen", "android");
        if (resourceId > 0) {
            result = App.Companion.getInstance().getResources().getDimensionPixelSize(resourceId);
        }
        return result;
    }
